...
func vnet(conf *Config) *arm.Resource {
	return &arm.Resource{
...
func ip(conf *Config) *arm.Resource {
	return &arm.Resource{
...
func nsg(conf *Config) *arm.Resource {
	return &arm.Resource{
...
func nic(conf *Config) *arm.Resource {
	return &arm.Resource{
...
func vm(conf *Config) *arm.Resource {
...
func cse(conf *Config, script []byte) (*arm.Resource, error) {
	buf := &bytes.Buffer{}
