...
export AZURE_MASTER_CLIENT_ID="$AZURE_CI_MASTER_CLIENT_ID"
export AZURE_MASTER_CLIENT_SECRET="$AZURE_CI_MASTER_CLIENT_SECRET"
export AZURE_WORKER_CLIENT_ID="$AZURE_CI_WORKER_CLIENT_ID"
export AZURE_WORKER_CLIENT_SECRET="$AZURE_CI_WORKER_CLIENT_SECRET"
