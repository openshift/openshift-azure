...
func (g *simpleGenerator) selectContainerImagesOrigin(cs *api.OpenShiftManagedCluster) error {
	...
	case "v3.11":
		...
		c.Images.Prometheus = "registry.access.redhat.com/openshift3/prometheus:latest"
...
func (g *simpleGenerator) selectContainerImages(cs *api.OpenShiftManagedCluster) error {
	...
	if g.pluginConfig.GenevaConfig.PromConverterImage != "" {
		cs.Config.Images.GenevaPromConverter = g.pluginConfig.GenevaConfig.PromConverterImage
	}
