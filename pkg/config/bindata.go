...
func etcdConf() (*asset, error) {
	bytes, err := etcdConfBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "etcd.conf", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"etcd.conf": {etcdConf, map[string]*bintree{}},
}}
