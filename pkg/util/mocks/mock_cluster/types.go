...
func (m *MockUpgrader) InitializeCluster(ctx context.Context, cs *api.OpenShiftManagedCluster) error {
	ret := m.ctrl.Call(m, "InitializeCluster", ctx, cs)
	ret0, _ := ret[0].(error)
	return ret0
}

// InitializeCluster indicates an expected call of InitializeCluster
func (mr *MockUpgraderMockRecorder) InitializeCluster(ctx, cs interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitializeCluster", reflect.TypeOf((*MockUpgrader)(nil).InitializeCluster), ctx, cs)
}
