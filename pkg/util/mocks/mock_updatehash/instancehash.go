...
func (m *MockUpdateHash) DeleteAllBut(arg0 map[updateblob.InstanceName]struct{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAllBut", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockUpdateHash) DeleteInstanceHash(arg0 updateblob.InstanceName) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteInstanceHash", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// HashScaleSets mocks base method
func (m *MockUpdateHash) HashScaleSets(arg0 api.PluginConfig, arg1 *api.OpenShiftManagedCluster) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HashScaleSets", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// HashScaleSets indicates an expected call of HashScaleSets
func (mr *MockUpdateHashMockRecorder) HashScaleSets(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HashScaleSets", reflect.TypeOf((*MockUpdateHash)(nil).HashScaleSets), arg0, arg1)
}

// Initialize mocks base method
func (m *MockUpdateHash) Initialize(arg0 *api.OpenShiftManagedCluster) error {
	m.ctrl.T.Helper()
...
func (mr *MockUpdateHashMockRecorder) Initialize(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Initialize", reflect.TypeOf((*MockUpdateHash)(nil).Initialize), arg0)
}
...
func (m *MockUpdateHash) UpdateInstanceHash(arg0 *compute.VirtualMachineScaleSetVM) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateInstanceHash", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
