...
type VirtualMachineScaleSetsClient interface {
	Get(ctx context.Context, resourceGroupName string, VMScaleSetName string) (compute.VirtualMachineScaleSet, error)
	List(ctx context.Context, resourceGroupName string) (compute.VirtualMachineScaleSetListResultPage, error)
...
type VirtualMachineScaleSetVMsClient interface {
	...
	Restart(ctx context.Context, resourceGroupName string, VMScaleSetName string, instanceID string) (compute.VirtualMachineScaleSetVMsRestartFuture, error)
...
type VirtualMachineScaleSetExtensionsClient interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, VMScaleSetName string, vmssExtensionName string, extensionParameters compute.VirtualMachineScaleSetExtension) (compute.VirtualMachineScaleSetExtensionsCreateOrUpdateFuture, error)
	Get(ctx context.Context, resourceGroupName string, VMScaleSetName string, vmssExtensionName string, expand string) (compute.VirtualMachineScaleSetExtension, error)
	List(ctx context.Context, resourceGroupName string, VMScaleSetName string) (compute.VirtualMachineScaleSetExtensionListResultPage, error)
	Client
}
