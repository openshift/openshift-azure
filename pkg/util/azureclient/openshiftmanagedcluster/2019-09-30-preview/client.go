...
func UserAgent() string {
	return "openshift-azure/pkg/api/2019-09-30-preview/api/client"
}
...
func (future *OpenShiftManagedClustersUpdateTagsFuture) Result(client OpenShiftManagedClustersClient) (osmc v20190930preview.OpenShiftManagedCluster, err error) {
	var done bool
...
func (client OpenShiftManagedClustersClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceName string, parameters v20190930preview.OpenShiftManagedCluster) (*http.Request, error) {
	...
	queryParameters := map[string]interface{}{
		"api-version": v20190930preview.APIVersion,
	}
...
// closes the http.Response Body.
func (client OpenShiftManagedClustersClient) GetResponder(resp *http.Response) (result v20190930preview.OpenShiftManagedCluster, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future *OpenShiftManagedClustersCreateOrUpdateFuture) Result(client OpenShiftManagedClustersClient) (osmc v20190930preview.OpenShiftManagedCluster, err error) {
	var done bool
	done, err = future.DoneWithContext(context.TODO(), client)
	if err != nil {
