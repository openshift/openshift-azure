...
func UserAgent() string {
	return "openshift-azure/pkg/api/2019-10-27-preview/api/client"
}
...
func (future *OpenShiftManagedClustersUpdateTagsFuture) Result(client OpenShiftManagedClustersClient) (osmc v20191027preview.OpenShiftManagedCluster, err error) {
	var done bool
	done, err = future.DoneWithContext(context.TODO(), client)
	if err != nil {
...
func (client OpenShiftManagedClustersClient) CreateOrUpdateAndWait(ctx context.Context, resourceGroupName, resourceName string, parameters v20191027preview.OpenShiftManagedCluster) (osmc v20191027preview.OpenShiftManagedCluster, err error) {
...
func (client OpenShiftManagedClustersClient) CreateOrUpdate(ctx context.Context, resourceGroupName, resourceName string, parameters v20191027preview.OpenShiftManagedCluster) (result OpenShiftManagedClustersCreateOrUpdateFuture, err error) {
...
func (client OpenShiftManagedClustersClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceName string, parameters v20191027preview.OpenShiftManagedCluster) (*http.Request, error) {
	...
	queryParameters := map[string]interface{}{
		"api-version": v20191027preview.APIVersion,
	}
...
func (client OpenShiftManagedClustersClient) CreateOrUpdateResponder(resp *http.Response) (result v20191027preview.OpenShiftManagedCluster, err error) {
...
// resourceGroupName - the name of the resource group.
// resourceName - the name of the openshift managed cluster resource.
func (client OpenShiftManagedClustersClient) Get(ctx context.Context, resourceGroupName string, resourceName string) (result v20191027preview.OpenShiftManagedCluster, err error) {
...
// closes the http.Response Body.
func (client OpenShiftManagedClustersClient) GetResponder(resp *http.Response) (result v20191027preview.OpenShiftManagedCluster, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
...
// closes the http.Response Body.
func (client OpenShiftManagedClustersClient) UpdateTagsResponder(resp *http.Response) (result v20191027preview.OpenShiftManagedCluster, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future *OpenShiftManagedClustersCreateOrUpdateFuture) Result(client OpenShiftManagedClustersClient) (osmc v20191027preview.OpenShiftManagedCluster, err error) {
	var done bool
	done, err = future.DoneWithContext(context.TODO(), client)
	if err != nil {
