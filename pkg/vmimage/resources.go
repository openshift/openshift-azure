...
func vnet(location string) *arm.Resource {
	return &arm.Resource{
...
func ip(resourcegroup, location, domainNameLabel string) *arm.Resource {
	return &arm.Resource{
...
func nsg(location string) *arm.Resource {
	return &arm.Resource{
...
func nic(subscriptionID, resourceGroup, location string) *arm.Resource {
	return &arm.Resource{
...
func vm(subscriptionID, resourceGroup, location, sshPublicKey string, plan *compute.Plan, imageReference *compute.ImageReference) *arm.Resource {
	return &arm.Resource{
...
func cse(location string, script []byte) (*arm.Resource, error) {
	buf := &bytes.Buffer{}
