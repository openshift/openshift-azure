...
func TestPluginTemplateValidate(t *testing.T) {
	expectedErrs :=
		[]error{
			...
			errors.New(`images.GenevaLogging cannot be empty`),
			errors.New(`images.GenevaTDAgent cannot be empty`),
			errors.New(`images.GenevaStatsd cannot be empty`),
			errors.New(`images.MetricsBridge cannot be empty`),
			errors.New(`images.ImagePullSecret cannot be empty`),
			...
			errors.New(`genevaLoggingControlPlaneEnvironment cannot be empty`),
			errors.New(`genevaLoggingControlPlaneRegion cannot be empty`),
