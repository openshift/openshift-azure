...
// v20190430.OpenShiftManagedCluster to an OpenShiftManagedCluster.
...
func ConvertFromv20190430(oc *v20190430.OpenShiftManagedCluster, old *api.OpenShiftManagedCluster) (*api.OpenShiftManagedCluster, error) {
...
func mergeFromResourcePurchasePlanv20190430(oc *v20190430.OpenShiftManagedCluster, cs *api.OpenShiftManagedCluster) {
	if cs.Plan == nil {
...
func mergeProperties(oc *v20190430.OpenShiftManagedCluster, cs *api.OpenShiftManagedCluster) error {
...
func mergeRouterProfiles(oc *v20190430.OpenShiftManagedCluster, cs *api.OpenShiftManagedCluster) error {
...
func convertRouterProfile(in v20190430.RouterProfile, old *api.RouterProfile) (out api.RouterProfile) {
	if old != nil {
		out = *old
	}
	if in.Name != nil {
...
func mergeAgentPoolProfiles(oc *v20190430.OpenShiftManagedCluster, cs *api.OpenShiftManagedCluster) error {
...
func convertMasterToAgentPoolProfile(in v20190430.MasterPoolProfile, old *api.AgentPoolProfile) (out api.AgentPoolProfile) {
	if old != nil {
		out = *old
	}
...
func convertAgentPoolProfile(in v20190430.AgentPoolProfile, old *api.AgentPoolProfile) (out api.AgentPoolProfile) {
	if old != nil {
		out = *old
	}
	if in.Name != nil {
...
func mergeAuthProfile(oc *v20190430.OpenShiftManagedCluster, cs *api.OpenShiftManagedCluster) error {
	...
	for _, ip := range oc.Properties.AuthProfile.IdentityProviders {
		...
		if index == -1 {
			...
			case (*api.AADIdentityProvider):
				in := ip.Provider.(*v20190430.AADIdentityProvider)
				if in.Kind != nil {
...
func convertIdentityProvider(in v20190430.IdentityProvider, old *api.IdentityProvider) (out api.IdentityProvider) {
	if old != nil {
		out = *old
	}
	if in.Name != nil {
	...
	if in.Provider != nil {
		...
		case (*v20190430.AADIdentityProvider):
